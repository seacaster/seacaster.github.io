...
then add your proficiency bonus if you're proficient in Stealth.
...
The flat bonuses for all saving throws and ability checks are on the character
sheet, but hopefully this helps explain the logic instead of seeing a bunch of
+1s and +3s.
